...
\fancyfoot[L]{\scriptsize \ttfamily Lab Assignment for Database System - Academic year 2025 - 2026}
...
\begin{center}
\begin{tabular}{c}
\multicolumn{1}{l}{\textbf{{\Large DATABASE SYSTEM (CO2014)}}}\\
~~\\
\hline
\\
\multicolumn{1}{l}{\textbf{{\Large Lab Assignment}}}\\
\\
\textbf{\textit{{\Huge Lab 5}}}\\
\\
\hline
\end{tabular}
\end{center}
...
\centering
    ...
    & \\[10pt]
    \textbf{Students}: &  Phạm Trần Minh Trí - 2313622 \emph{(Group TN01)} \\
    &  Lê Nguyễn Kim Khôi - 2311671 \emph{(Group TN01)} \\
...
\input{exercise-1.tex}

\input{exercise-2.tex}
